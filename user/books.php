  ...
  <main class="relative w-full bg-light">
    ...
    <div class="w-full md:w-10/12 mx-auto p-2">
      <div class="flex justify-between items-center">
        ...
        <a href="upload-book.php" class="app-button px-4 py-2 rounded-3xl bg-primary text-light bg-gradient-to-r from-[#00000044] to-transparent ms-3"><i class="fas fa-plus"></i> &nbsp; Upload Book</a>

      </div>
      <p class="font-bold">books you have added</p>
